...
app.get('/api/mailboxes/status',route(()=>mailboxOperations.status()));
app.post('/api/mailboxes/detect',route(i=>mailboxOperations.detect(i)));
app.post('/api/mailboxes/oauth',route(i=>mailboxOperations.startOauth(i)));
app.post('/api/mailboxes/smtp',route(i=>mailboxOperations.connectSmtp(i)));
app.post('/api/mailboxes/test',route(i=>mailboxOperations.testSend(i)));
app.post('/api/mailboxes/disconnect',route(i=>mailboxOperations.disconnect(i)));
